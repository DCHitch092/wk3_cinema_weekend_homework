...
film1 = Film.new( 'title' => 'Lard Day\'s Night', 'price' => '5')
film2 = Film.new( 'title' => 'Yellow Flubmarine', 'price' => '7')
film3 = Film.new( 'title' => 'Yelp!', 'price' => '2')

film1.save()
film2.save()
film3.save()

screening1 = Screening.new( 'time' => '16:00', 'film_id' => film3.id, 'seats' => '10')
screening2 = Screening.new( 'time' => '20:00', 'film_id' => film3.id, 'seats' => '10')
screening3 = Screening.new( 'time' => '23:00', 'film_id' => film3.id, 'seats' => '8')

screening1.save()
screening2.save()
screening3.save()

# ticket_01 = Ticket.new( 'customer_id' => customer1.id, 'film_id' => film1.id, 'screening_id' =>)
